...
class AnswersquestionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'answerindex' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'user_id' => 1,
            'answerindex' => 1,
            'created' => '2018-01-30 01:52:28',
            'modified' => '2018-01-30 01:52:28'
        ],
    ];
}
